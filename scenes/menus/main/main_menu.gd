...
"Fun fact: it's possible to reach WEGAKILL rank without collecting any Wegadolls!",
...
"Outside of CLASSIC, falling deals 100 damage. If only there was a way to go over that...",
"Styling on enemies will regenerate HP!",
"Golden Sigma will always save you after a Rorys Explosion!",
"You cannot run from Shoe Bench.",
"Super John can only hit you when he's going at high speed. To tell if he can hit you, look for his unique dash animation!",
"Super John can be deflected with ATTACK (Left Click)."
]
