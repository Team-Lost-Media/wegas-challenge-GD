...
const DEFAULT_SETTINGS = {"selected resolution": 2, "resolution": [1920, 1080], "vsync": true, "fullscreen": false, "sfx volume" : 1, "music volume" : 1, "fov" : 100, "sensitivity" : 10} # Settings that are set by default, in case if settings file does not exist

var fov: float = 110 #ignore this
